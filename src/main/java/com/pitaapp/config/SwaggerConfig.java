...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.pitaapp.controller"))
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Projeto Pita").description("Projeto API Spring - Projeto Pita")
